...
export default function NavBar() {
  ...
  return (
    <div>
      <div className="flex w-full lg:justify-between px-3 border-b-2 justify-end">
        ...
        <div className="flex gap-7 text-lg items-center">
          <p className="text-sm cursor:pointer hover:bg-blue-100 px-4 py-2 rounded-lg">
            <Link to={'/'}>Home </Link>
          </p>
          {!value ? (
            ...
            <>
              ...
              <button
                className="text-sm hover:bg-blue-100 px-4 py-2 rounded-lg"
